...
@Client.on_message(filters.command(['directdl', 'stream', 'stream@Miku_Nakano_Leeching_Bot', 'zipdirectdl', 'zipdirect', 'filedirectdl', 'document@Miku_Nakano_Leeching_Bot', 'document']) & filters.chat(ALL_CHATS))
